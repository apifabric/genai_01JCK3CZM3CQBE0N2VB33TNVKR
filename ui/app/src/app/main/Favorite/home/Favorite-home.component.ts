...
@Component({
  selector: 'Favorite-home',
  templateUrl: './Favorite-home.component.html',
  styleUrls: ['./Favorite-home.component.scss']
})
export class FavoriteHomeComponent implements AfterViewInit {
