...
@Component({
  selector: 'DatingPlatform-home',
  templateUrl: './DatingPlatform-home.component.html',
  styleUrls: ['./DatingPlatform-home.component.scss']
})
export class DatingPlatformHomeComponent implements AfterViewInit {
