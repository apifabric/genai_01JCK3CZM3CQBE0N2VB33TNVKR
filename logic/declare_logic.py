...
def declare_logic():
    ...
    # Tracks and limits the number of unique interactions a user can have with a candidate, e.g., maximum of 5 interactions.
    Rule.count(derive=Candidate.interaction_count, as_count_of=Interaction)
    Rule.constraint(
    validate=Candidate,
